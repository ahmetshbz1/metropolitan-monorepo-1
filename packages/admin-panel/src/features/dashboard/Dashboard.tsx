...
const StatCard = ({ title, value, icon, color }: StatCardProps) => {
  const iconClasses = {
    ...
    success: "bg-green-50 text-green-600 dark:bg-green-950/50 dark:text-green-400",
    warning: "bg-orange-50 text-orange-600 dark:bg-orange-950/50 dark:text-orange-400",
    secondary: "bg-purple-50 text-purple-600 dark:bg-purple-950/50 dark:text-purple-400",
  };
    ...
    <Card className="border border-slate-200 dark:border-[#2a2a2a]">
      <CardBody className="p-6">
        <div className="flex items-start justify-between">
          ...
          <div className={`rounded-lg p-2.5 ${iconClasses[color]}`}>
            {icon}
          </div>
        </div>
      </CardBody>
        ...
        <Card className="border border-slate-200 dark:border-[#2a2a2a]">
          <CardBody className="p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="text-xs text-slate-500 dark:text-slate-400">Son 30 Gün</span>
            </div>
        ...
        <Card className="border border-slate-200 dark:border-[#2a2a2a]">
          <CardBody className="p-6">
            ...
            {stats.topProducts.length === 0 ? (
              <div className="flex h-[300px] items-center justify-center rounded-lg border border-dashed border-slate-200 dark:border-[#2a2a2a]">
                <p className="text-sm text-slate-500 dark:text-slate-400">
        ...
        <Card className="border border-slate-200 dark:border-[#2a2a2a]">
          <CardBody className="p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="text-xs text-slate-500 dark:text-slate-400">Son 10</span>
            </div>
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                        {order.customerName || "Misafir"} • {new Date(order.createdAt).toLocaleDateString("tr-TR", {
                          day: "numeric",
                          month: "short",
                          hour: "2-digit",
                          minute: "2-digit",
